...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            {
                Console.WriteLine("{0} is not a upported gradbook, please try again", type);
                return;
            }
        ...
        public static void HelpCommand()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Create 'Name' 'Type' - Creates a new gradebook where 'Name' is the name of the gradebook. and 'Type' is what kind of type you should use");
            Console.WriteLine();
